...
{
    public int sum;
    public System.Collections.Generic.Dictionary<int, int> variables = new System.Collections.Generic.Dictionary<int, int>();
    public int positiveCount;
    public int negativeCount;
    public System.Collections.Generic.Dictionary<int, (int, int)> assignedVariables = new System.Collections.Generic.Dictionary<int, (int, int)>();
...
{
    public Array<int> clauses = new Array<int>();
    public int value;
}
public partial class CSPSolver : Node
{
    Array<CSPClause> clauses = new Array<CSPClause>();
    Dictionary<int, int> weightDict = new Dictionary<int, int>();
    Array<CSPVariable> variables = new Array<CSPVariable>();
    public void Clear()
    {
        clauses.Clear();
        weightDict.Clear();
    ...
    public void AddClause(Dictionary<int, int> variableCoefMap, int sum)
    {
        ...
        clause.sum = sum;
        foreach (var kv in variableCoefMap)
        {
            int variable = kv.Key;
            int coef = kv.Value;
    ...
    bool Satisfiable()
    {
        ...
        foreach (var kv in clauses[min_id].variables)
        {
            int variable = kv.Key;
